...
/// O vocabulário de desenho vive em `crate::painel` desde que deixou de ser só da Invest
/// — ver o cabeçalho de lá. Reexportado aqui porque, para um módulo desta aba, `Pane` e
/// `Tone` continuam sendo parte do contrato que ele implementa.
pub use crate::painel::{Bar, Cell, Field, Layout, Pane, Row, Tone};
